...
@ObjectType()
export class GetSemestersEntity {
...
export class GetCoursesEntity {
  ...
  @Field(() => [GetSemestersEntity], {
    description: 'Semester details',
  })
  semesters: GetSemestersEntity[];
...
@ObjectType()
export class AdminListCourseEntity {
  @Field(() => [GetCoursesEntity], {
    description: 'Courses Detail with semester',
    nullable: true,
  })
  list_course: GetCoursesEntity[];
